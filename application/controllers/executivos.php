...
class Executivos extends Geral {
	public function __construct()
	{
        ...
        */
		...
		$this->load->model('Executivos_model');
	}
	public function index($page = 1)
    {
		$this->data['executivos'] = $this->Executivos_model->get_projetos_executivos($page);
        $this->data['paginacao']['size'] = (!empty($this->data['sessoes']) ? $this->data['sessoes'][0]['Size'] : 0);
        $this->data['paginacao']['pg_atual'] = $page;

		$this->data['lista_categoria'] = $this->Executivos_model->get_categoria();
