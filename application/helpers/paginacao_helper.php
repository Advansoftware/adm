						...
						echo"<ul class='pagination'>";
							echo"<li class='page-item'>";
								if(!empty($paginacao['pg_atual']) && $paginacao['pg_atual'] > 1)						
									echo"<a class='page-link disabled' href='".$paginacao['url'] . $controller."/".$method."/".$parameter. ($paginacao['pg_atual'] - 1).$filtros."' aria-label='Previous'><span class='glyphicon fa fa-arrow-left'></span>&nbsp;</a>";
							echo"</li>";
							...
							echo"<li class='page-item'>";
								if($paginacao['pg_atual'] < ceil($qtd_paginas))
									echo"<a class='page-link' href='".$paginacao['url'] . $controller."/".$method."/".$parameter. ($paginacao['pg_atual'] + 1).$filtros."' aria-label='Next'><span class='fa fa-arrow-right'></span>&nbsp;</a>";
							echo"</li>";
						echo"</ul>";
					echo"</nav>";
				echo "</div>";
